...
public class Crawler implements Serializable{
	...
	private enum Month {DUMMY, JANUARY, FEBRUARY, MARCH, APRIL, MAY, JUNE, JULY, AUGUST, 
	...
	public void search(String url, String searchWord, boolean isRestore) throws Exception
	{
		...
		do
		{
			...
			CrawlerUtil pageCrawler = new CrawlerUtil();
			...
			else
			{
				...
				if(this.currentUrl!=null )
				{
					...
					{
						CrawlerUtil mailCrawler = new CrawlerUtil();
	...
	/**
	 * Method for adding elements to list and avoid duplicates
	 * @param list
	 *  - List in which the links needs to be inserted.
	 * @param hyperLinks
	 *  - List from which the links needs to be inserted.
	 */
